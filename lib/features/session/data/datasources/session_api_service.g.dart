...
class _SessionApiService implements SessionApiService {
  ...
  Future<List<SessionModel>> getSessions() async {
    ...
    final _options = _setStreamType<List<SessionModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<SessionModel> getSessionById(int id) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<SessionModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<MessageResponse> getMessages(String id) async {
    ...
    final _options = _setStreamType<MessageResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'agents/research/sessions/${id}/messages',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<SourcesResponse> getSources(String id) async {
    ...
    final _options = _setStreamType<SourcesResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'agents/research/sessions/${id}/sources',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<ArtifactsResponse> getArtifacts(String id) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ArtifactsResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
        .compose(
          _dio.options,
          'agents/research/sessions/${id}/artifacts',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
